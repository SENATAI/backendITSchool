...
class GetNotAvailableListProductUseCaseProtocol(UseCaseProtocol[ProductPaginationResultSchema]):
...
class GetNotAvailableProductUseCase(GetNotAvailableListProductUseCaseProtocol):
    ...
    async def __call__(self,
        ...
        return await self.product_service.paginate_not_available(pagination, price)
