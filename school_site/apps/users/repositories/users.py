...
from school_site.apps.users.schemas import UserReadDBSchema, UserCreateSchema, UserUpdateSchema
...
class UserRepositoryProtocol(BaseRepositoryImpl[
    ...
    async def get_by_username(username: str) -> UserReadDBSchema:
        ...


class UserRepository(UserRepositoryProtocol):
    async def get_by_username(self, username: str) -> UserReadDBSchema:
