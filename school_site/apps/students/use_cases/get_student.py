...
from ..schemas import StudentReadSchema

class GetStudentUseCaseProtocol(UseCaseProtocol[StudentReadSchema]):
    async def __call__(self, access_token: str, student_id: UUID) -> StudentReadSchema:
        ...
