...
class LessonStudentServiceProtocol(Protocol):
    async def create(self, lesson_student: LessonStudentCreateSchema) -> LessonStudentReadSchema:
        ...

    async def get(self, lesson_student_id: UUID) -> LessonStudentReadSchema:
        ...

    async def update(self, lesson_student_id: UUID, LessonStudent: LessonStudentUpdateSchema) -> LessonStudentReadSchema:
        ...

    async def delete(self, lesson_student_id: UUID) -> None:
        ...

    async def bulk_create(self, lesson_students: list[LessonStudentCreateSchema]) -> list[LessonStudentReadSchema]:
        ...


class LessonStudentService(LessonStudentServiceProtocol):
    def __init__(self, lesson_student_repository: LessonStudentRepositoryProtocol):
    ...
    async def update(self, lesson_student_id: UUID, lesson_student: LessonStudentUpdateSchema) -> LessonStudentReadSchema:
